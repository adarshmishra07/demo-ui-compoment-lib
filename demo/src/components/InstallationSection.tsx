    ...
    <section id="installation" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <motion.div
            variants={fadeInUp}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-indigo-500/20 to-cyan-500/20 border border-indigo-500/30 text-sm text-indigo-200 mb-6"
          >
          ...
          >
            Get ZyFAi UI up and running in your project with just a few
            commands. No complex setup, no configuration headaches.
          </motion.p>
        </motion.div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            >
              {/* Header */}
              <div className="p-6 border-b border-white/10 bg-gradient-to-r from-indigo-500/10 to-cyan-500/10 flex flex-col gap-2">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        Import and start using components immediately
                      </p>
                    </div>
                  </div>
                  <Button
          ...
          >
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://www.npmjs.com/package/am-zy-components",
                    "_blank"
                  )
                }
              >
